                ...
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-8 xl:gap-24">
                    ...
                    <div className="space-y-6 py-5">
                        ...
                        <div className="flex gap-6">
                            <button type="button" tabIndex={0} data-slot="button" className="cn-button group/button inline-flex gap-4 border-2 border-blue-700 p-2 rounded-md hover:bg-blue-500 shrink-0 items-center justify-center whitespace-nowrap transition-all outline-none select-none disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:shrink-0 cn-button-variant-default cn-button-size-lg grow">

                ...
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-8 xl:gap-24">
                    ...
                    <div className="space-y-6 py-5">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-muted-foreground font-medium line-through">Rp ${/*<!-- -->*/}70.000</span><span data-slot="badge" data-variant="default" className="cn-badge group/badge focus-visible:border-ring aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 inline-flex w-fit shrink-0 items-center justify-center overflow-hidden whitespace-nowrap focus-visible:ring-[3px] [&amp;&gt;svg]:pointer-events-none cn-badge-variant-default border-none bg-green-600/10 text-green-600 focus-visible:ring-green-600/20 focus-visible:outline-none dark:bg-green-400/10 dark:text-green-400 dark:focus-visible:ring-green-400/40 [a&amp;]:hover:bg-green-600/5 dark:[a&amp;]:hover:bg-green-400/5">30{/*<!-- -->*/}% Off</span>
                        </div>
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div role="radiogroup" data-slot="radio-group" className="cn-radio-group w-full flex gap-3!">
                               ...
                               <label className="has-focus-visible:ring-ring/50 relative size-5 cursor-pointer rounded-full text-center shadow-xs transition-[color,box-shadow] outline-none has-focus-visible:ring-[3px] has-data-disabled:cursor-not-allowed has-data-disabled:opacity-50 has-data-checked:outline-solid has-data-checked:outline has-data-checked:outline-offset-2 has-data-checked:outline-green-600 bg-green-600"><span data-unchecked="" role="radio" tabIndex={-1} aria-checked="false" id="base-ui-_R_1cuslubsnpfiv9fiv5uj9b_" data-slot="radio-group-item" aria-label="color-radio-green" className="cn-radio-group-item group/radio-group-item peer aspect-square shrink-0 border outline-none after:absolute after:-inset-x-3 after:-inset-y-2 disabled:cursor-not-allowed disabled:opacity-50 absolute inset-0 opacity-0"></span><input type="radio" id="_R_4lubsnpfiv9fiv5uj9b_-green" tabIndex={-1} style={{clipPath:"inset(50%)", overflow:"hidden", whiteSpace:"nowrap", border:0, padding:0, width:"1px", height:"1px", margin:"-1px", position:"fixed", top:0, left:0}} aria-hidden="true" value="green" />250 gr</label>
                              <label className="has-focus-visible:ring-ring/50 relative size-5 cursor-pointer rounded-full text-center shadow-xs transition-[color,box-shadow] outline-none has-focus-visible:ring-[3px] has-data-disabled:cursor-not-allowed has-data-disabled:opacity-50 has-data-checked:outline-solid has-data-checked:outline has-data-checked:outline-offset-2 has-data-checked:outline-amber-600 bg-amber-600"><span data-unchecked="" role="radio" tabIndex={-1} aria-checked="false" id="base-ui-_R_1suslubsnpfiv9fiv5uj9b_" data-slot="radio-group-item" aria-label="color-radio-orange" className="cn-radio-group-item group/radio-group-item peer aspect-square shrink-0 border outline-none after:absolute after:-inset-x-3 after:-inset-y-2 disabled:cursor-not-allowed disabled:opacity-50 absolute inset-0 opacity-0"></span><input type="radio" id="_R_4lubsnpfiv9fiv5uj9b_-orange" tabIndex={-1} style={{clipPath:"inset(50%)", overflow:"hidden", whiteSpace:"nowrap", border:0, padding:0, width:"1px", height:"1px", margin:"-1px", position:"fixed", top:0, left:0}} aria-hidden="true" value="orange" />500 gr</label>
                              <label className="has-focus-visible:ring-ring/50 relative size-5 cursor-pointer rounded-full text-center shadow-xs transition-[color,box-shadow] outline-none has-focus-visible:ring-[3px] has-data-disabled:cursor-not-allowed has-data-disabled:opacity-50 has-data-checked:outline-solid has-data-checked:outline has-data-checked:outline-offset-2 has-data-checked:outline-gray-200 bg-gray-200"><span data-unchecked="" role="radio" tabIndex={-1} aria-checked="false" id="base-ui-_R_2cuslubsnpfiv9fiv5uj9b_" data-slot="radio-group-item" aria-label="color-radio-gray" className="cn-radio-group-item group/radio-group-item peer aspect-square shrink-0 border outline-none after:absolute after:-inset-x-3 after:-inset-y-2 disabled:cursor-not-allowed disabled:opacity-50 absolute inset-0 opacity-0"></span><input type="radio" id="_R_4lubsnpfiv9fiv5uj9b_-gray" tabIndex={-1} style={{clipPath:"inset(50%)", overflow:"hidden", whiteSpace:"nowrap", border:0, padding:0, width:"1px", height:"1px", margin:"-1px", position:"fixed", top:0, left:0}} aria-hidden="true" value="gray" />750 gr</label>
                              <label className="has-focus-visible:ring-ring/50 relative size-5 cursor-pointer rounded-full text-center shadow-xs transition-[color,box-shadow] outline-none has-focus-visible:ring-[3px] has-data-disabled:cursor-not-allowed has-data-disabled:opacity-50 has-data-checked:outline-solid has-data-checked:outline has-data-checked:outline-offset-2 has-data-checked:outline-blue-500 bg-blue-500"><span data-unchecked="" role="radio" tabIndex={-1} aria-checked="false" id="base-ui-_R_2suslubsnpfiv9fiv5uj9b_" data-slot="radio-group-item" aria-label="color-radio-blue" className="cn-radio-group-item group/radio-group-item peer aspect-square shrink-0 border outline-none after:absolute after:-inset-x-3 after:-inset-y-2 disabled:cursor-not-allowed disabled:opacity-50 absolute inset-0 opacity-0"></span><input type="radio" id="_R_4lubsnpfiv9fiv5uj9b_-blue" tabIndex={-1} style={{clipPath:"inset(50%)", overflow:"hidden", whiteSpace:"nowrap", border:0, padding:0, width:"1px", height:"1px", margin:"-1px", position:"fixed", top:0, left:0}} aria-hidden="true" value="blue" />1000 gr</label>
                            </div>
                        </div>
                        <div className="flex items-center gap-6">

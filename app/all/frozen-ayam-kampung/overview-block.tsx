                    ...
                    <div className="space-y-6 py-5">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div role="radiogroup" data-slot="radio-group" className="cn-radio-group w-full flex gap-3!">
                               ...
                               <label className="has-focus-visible:ring-ring/50 relative flex size-5 cursor-pointer rounded-full text-center shadow-xs transition-[color,box-shadow] outline-none has-focus-visible:ring-[3px] has-data-disabled:cursor-not-allowed has-data-disabled:opacity-50 has-data-checked:outline-solid has-data-checked:outline has-data-checked:outline-offset-2 has-data-checked:outline-green-600 bg-green-600"><span data-unchecked="" role="radio" tabIndex={-1} aria-checked="false" id="base-ui-_R_1cuslubsnpfiv9fiv5uj9b_" data-slot="radio-group-item" aria-label="color-radio-green" className="cn-radio-group-item group/radio-group-item peer aspect-square shrink-0 border outline-none after:absolute after:-inset-x-3 after:-inset-y-2 disabled:cursor-not-allowed disabled:opacity-50 absolute inset-0 opacity-0"></span><input type="radio" id="_R_4lubsnpfiv9fiv5uj9b_-green" tabIndex={-1} style={{clipPath:"inset(50%)", overflow:"hidden", whiteSpace:"nowrap", border:0, padding:0, width:"1px", height:"1px", margin:"-1px", position:"fixed", top:0, left:0}} aria-hidden="true" value="green" /><span>250 gr</span></label>
                              <label className="has-focus-visible:ring-ring/50 relative flex size-5 cursor-pointer rounded-full text-center shadow-xs transition-[color,box-shadow] outline-none has-focus-visible:ring-[3px] has-data-disabled:cursor-not-allowed has-data-disabled:opacity-50 has-data-checked:outline-solid has-data-checked:outline has-data-checked:outline-offset-2 has-data-checked:outline-amber-600 bg-amber-600"><span data-unchecked="" role="radio" tabIndex={-1} aria-checked="false" id="base-ui-_R_1suslubsnpfiv9fiv5uj9b_" data-slot="radio-group-item" aria-label="color-radio-orange" className="cn-radio-group-item group/radio-group-item peer aspect-square shrink-0 border outline-none after:absolute after:-inset-x-3 after:-inset-y-2 disabled:cursor-not-allowed disabled:opacity-50 absolute inset-0 opacity-0"></span><input type="radio" id="_R_4lubsnpfiv9fiv5uj9b_-orange" tabIndex={-1} style={{clipPath:"inset(50%)", overflow:"hidden", whiteSpace:"nowrap", border:0, padding:0, width:"1px", height:"1px", margin:"-1px", position:"fixed", top:0, left:0}} aria-hidden="true" value="orange" /><span>500 gr</span></label>
                              ...
                              <label className="has-focus-visible:ring-ring/50 relative flex size-5 cursor-pointer rounded-full text-center shadow-xs transition-[color,box-shadow] outline-none has-focus-visible:ring-[3px] has-data-disabled:cursor-not-allowed has-data-disabled:opacity-50 has-data-checked:outline-solid has-data-checked:outline has-data-checked:outline-offset-2 has-data-checked:outline-blue-500 bg-blue-500"><span data-unchecked="" role="radio" tabIndex={-1} aria-checked="false" id="base-ui-_R_2suslubsnpfiv9fiv5uj9b_" data-slot="radio-group-item" aria-label="color-radio-blue" className="cn-radio-group-item group/radio-group-item peer aspect-square shrink-0 border outline-none after:absolute after:-inset-x-3 after:-inset-y-2 disabled:cursor-not-allowed disabled:opacity-50 absolute inset-0 opacity-0"></span><input type="radio" id="_R_4lubsnpfiv9fiv5uj9b_-blue" tabIndex={-1} style={{clipPath:"inset(50%)", overflow:"hidden", whiteSpace:"nowrap", border:0, padding:0, width:"1px", height:"1px", margin:"-1px", position:"fixed", top:0, left:0}} aria-hidden="true" value="blue" /><span>1000 gr</span></label>
                            </div>
                        </div>
                        <div className="flex items-center gap-6">

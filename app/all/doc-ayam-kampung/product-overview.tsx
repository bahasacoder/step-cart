                ...
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-8 xl:gap-24">
                    ...
                    <div className="space-y-6 py-5">
                        ...
                        <div className="flex gap-6">
                            <button type="button" tabIndex="0" data-slot="button" className="cn-button group/button inline-flex shrink-0 items-center justify-center whitespace-nowrap transition-all outline-none select-none disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:shrink-0 cn-button-variant-default cn-button-size-lg grow"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" lucide="ShoppingCartIcon" tabler="IconShoppingCart" hugeicons="ShoppingCart01Icon" phosphor="ShoppingCartSimpleIcon" remixicon="RiShoppingCartLine" className="remixicon ">
                                ...
                                </svg>Add to Cart</button><button type="button" tabIndex="0" data-slot="button" className="cn-button group/button inline-flex shrink-0 items-center justify-center whitespace-nowrap transition-all outline-none select-none disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:shrink-0 cn-button-variant-secondary cn-button-size-lg grow"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" lucide="HeartIcon" tabler="IconHeart" hugeicons="FavouriteIcon" phosphor="HeartIcon" remixicon="RiHeartLine" className="remixicon ">
                        ...
                        <div className="rounded-md border *:not-last:border-b">
                            <div className="flex items-center gap-6 px-6 py-4">
                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" lucide="TruckIcon" tabler="IconTruck" hugeicons="TruckIcon" phosphor="TruckIcon" remixicon="RiTruckLine" className="remixicon size-7">
                            ...
                            <div className="flex items-center gap-6 px-6 py-4">
                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" lucide="RefreshCcwIcon" tabler="IconRefresh" hugeicons="Refresh03Icon" phosphor="ArrowsCounterClockwiseIcon" remixicon="RiResetLeftLine" className="remixicon size-7">

    ...
    <>
     <div className="ba b--lighter-gray br3 overflow-hidden">
        ...
        <div className="flex w-100" aria-label="Food condition: Frozen">
            <div className="f6 lh-copy self-stretch pa3" aria-hidden="true" style={{width: "225px", minWidth: "225px", backgroundColor: "rgb(248, 248, 248)"}}>Food condition</div>
            <div className="bg-white flex-auto f6 pa3" aria-hidden="true">
        ...
        <div className="flex w-100" aria-label="Shelf life: 270 days">
            <div className="f6 lh-copy self-stretch pa3" aria-hidden="true" style={{width: "225px", minWidth: "225px", backgroundColor: "rgb(248, 248, 248)"}}>Shelf life</div>
            <div className="bg-white flex-auto f6 pa3" aria-hidden="true">
        ...
        <div className="flex w-100" aria-label="Fresh &amp; frozen poultry type: Chicken">
            ...
            <div className="bg-white flex-auto f6 pa3" aria-hidden="true">
                <div className="b lh-copy">Ayam Kampung</div>
            </div>
        </div>
        <hr aria-hidden="true" className="ld_Au" />
        <div className="flex w-100" aria-label="Flavor: Unflavored">
            <div className="f6 lh-copy self-stretch pa3" aria-hidden="true" style={{width: "225px", minWidth: "225px", backgroundColor: "rgb(248, 248, 248)"}}>Flavor</div>
            <div className="bg-white flex-auto f6 pa3" aria-hidden="true">

...
export default function Footer() {
  ...
  return (
    ...
    <div className="mx-auto flex max-w-7xl flex-wrap justify-between gap-3 px-4 py-6 max-sm:flex-col sm:items-center sm:px-6">
        ...
        <div className="flex w-fit gap-x-5 gap-y-3 max-sm:flex-col"><a href="https://themeselection.com"><img src="https://cdn.themeselection.com/ts-assets/themeselection/logo/logo.png" alt="themeselection logo" className="h-7.5" /></a>
            <div data-orientation="vertical" data-slot="separator" className="bg-border shrink-0 data-[orientation=horizontal]:h-px data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-px !h-7 max-sm:hidden"><br /></div><a href="https://pixinvent.com"><img src="https://cdn.themeselection.com/ts-assets/pixinvent/logo/logo.png" alt="pixinvent logo" className="h-7.5" /></a>
            <div data-orientation="vertical" data-slot="separator" className="bg-border shrink-0 data-[orientation=horizontal]:h-px data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-px !h-7 max-sm:hidden"><br /></div><a href="https://pixinvent.com"><img src="https://ts-assets.b-cdn.net/ts-assets/jetship/jetship-laravel-boilerplate/logo/logo.png" alt="jetship logo" className="h-7.5" /></a>
        </div>
    </div>
    <div data-orientation="horizontal" data-slot="separator" className="bg-border shrink-0 data-[orientation=horizontal]:h-px data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-px"><br /></div>
    <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-6 sm:px-6">
        ...
        <div className="flex flex-wrap items-center gap-4"><span data-slot="badge" className="focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border px-2 py-0.5 whitespace-nowrap transition-[color,box-shadow] focus-visible:ring-[3px] [&>svg]:pointer-events-none [&>svg]:size-3 text-foreground [a&]:hover:bg-accent [a&]:hover:text-accent-foreground text-base font-normal"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" className="lucide lucide-shield-check !size-4.5 text-green-600" aria-hidden="true">
                    <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path>
                    <path d="m9 12 2 2 4-4"></path>
                </svg> Secure Payment</span><img src="https://cdn.shadcnstudio.com/ss-assets/brand-logo/lemon-squeezy.png" alt="Lemon Squeezy" className="h-6 dark:hidden" /><img src="https://cdn.shadcnstudio.com/ss-assets/brand-logo/lemon-squeezy-white.png" alt="Lemon Squeezy" className="hidden h-6 dark:inline-block" /><img src="https://cdn.shadcnstudio.com/ss-assets/brand-logo/visa.png" alt="Visa" className="h-5" /><img src="https://cdn.shadcnstudio.com/ss-assets/brand-logo/paypal.png" alt="Paypal" className="h-5" /><img src="https://cdn.shadcnstudio.com/ss-assets/brand-logo/master.png" alt="Mastercard" className="h-5" />
          </div>
    </div>
</footer>
  )  

          ...
          <DialogContent className="sm:max-w-md">            
             <DialogTitle></DialogTitle>
              <div className="relative flex flex-col gap-4 w-full max-h-[500px] mx-auto my-auto p-4">
                 <h1 className=" w-full text-center text-5xl font-bold tracking-normal transition-all duration-300 ease-in-out hover:scale-110 hover:text-blue-700 hover:font-bold hover:tracking-wider">Bangun Website Anda, Bersama Kami!</h1>
                ...
                <h2 className=" w-full text-center text-3xl font-bold tracking-normal transition-all duration-300 ease-in-out hover:scale-110 hover:text-blue-700 hover:font-bold hover:tracking-wider">Kami Melayani Pembuatan Website UMKM</h2>
                </div>
          </DialogContent>
        </Dialog>

          ...
          <DialogContent className="sm:max-w-md">            
             <DialogTitle></DialogTitle>
              <div className="relative h-48 w-48 mx-auto my-auto p-4">
                 <h1 className="absolute top-0 left-0 text-3x z-10 font-bold tracking-normal text-blue-600 transition-all duration-300 ease-in-out hover:text-purple-600 hover:font-bold hover:tracking-widest">Kami Juga Melayani Pembuatan Website UMKM</h1>
                  <Image
